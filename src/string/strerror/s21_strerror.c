...
/* macOS / Darwin: errno 0-106 (POSIX + BSD extensions) */
#define MAX_KNOWN_ERROR 107
...
#else
/* Linux / glibc: errno 0-133. Entries 41 and 58 undefined on Linux */
...
static const char* error_descriptions[] = {
    ...
    "Directory not empty",
    "Too many levels of symbolic links",
    S21_NULL, /* 41: undefined on Linux */
    "No message of desired type",
    "Identifier removed",
    ...
    "Invalid slot",
    S21_NULL, /* 58: undefined on Linux */
...
char* s21_strerror(int errnum) {
  ...
  if (errnum >= 0 && errnum < MAX_KNOWN_ERROR &&
      error_descriptions[errnum] != S21_NULL) {
